...
export const siteUrl = {
  ...
  href: 'https://comunidadesfindbeuropa.com/',
};
...
export type InfluencerMenuItem = {
  id: string;
  title: string;
  description: string;
  items: string[];
...
export const influencerMenuItems: InfluencerMenuItem[] = [
  {
    id: 'dashboard',
    title: 'Dashboard',
    description: 'Prévia dos resultados, ganhos, campanhas e estatísticas.',
    items: ['Ganhos', 'Campanhas', 'Cliques', 'Conversões'],
  },
  {
    id: 'perfil',
    title: 'Meu Perfil',
    description: 'Mantenha seus dados e redes sociais atualizados.',
    items: ['Foto', 'País onde reside', 'Categorias', 'Documentação'],
  },
  {
    id: 'link',
    title: 'Meu Link',
    description: 'Compartilhe sua URL exclusiva de indicação.',
    items: ['Copiar link', 'Gerar QR Code', 'Compartilhar', 'Personalizar URL'],
  },
  {
    id: 'campanhas',
    title: 'Campanhas',
    description: 'Veja objetivos, prazos, valores e materiais oficiais.',
    items: ['Disponíveis', 'Valor', 'Prazo', 'Status'],
  },
  {
    id: 'conteudo',
    title: 'Central de Conteúdo',
    description: 'Baixe materiais prontos para publicar nas suas redes.',
    items: ['Vídeos', 'Stories', 'Reels', 'Textos', 'Hashtags'],
  },
  {
    id: 'ganhos',
    title: 'Ganhos',
    description: 'Apresentação de saldo, extrato e próximos pagamentos.',
    items: ['Disponível', 'Pendente', 'Histórico', 'Pagamentos'],
  },
  {
    id: 'estatisticas',
    title: 'Estatísticas',
    description: 'Prévia de desempenho para campanhas futuras.',
    items: ['Cliques', 'Cadastros', 'Visualizações', 'Comissões'],
  },
  {
    id: 'ranking',
    title: 'Ranking',
    description: 'Compare sua evolução e desbloqueie conquistas.',
    items: ['Semanal', 'Mensal', 'Anual', 'Badges'],
  },
  {
    id: 'desafios',
    title: 'Desafios',
    description: 'Participe de missões especiais e campanhas sazonais.',
    items: ['Bônus', 'Recompensas', 'Embaixadores'],
  },
  {
    id: 'indicacao',
    title: 'Indique um Influenciador',
    description: 'Convide criadores e ganhe bônus quando forem aprovados.',
    items: ['Convites', 'Aprovações', 'Bônus'],
  },
  {
    id: 'configuracoes',
    title: 'Configurações',
    description: 'Gerencie idioma, notificações, privacidade e termos.',
    items: ['Pagamento', 'Privacidade', 'Termos'],
  },
];

export const influencerEarningWays = [
...
export const countryFlagPreview = ['pt', 'es', 'fr', 'de', 'it', 'nl', 'be', 'ie', 'at', 'ch', 'se', 'no', 'dk', 'fi'];
