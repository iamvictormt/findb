...
const feedback = {
  ...
  influencerEmailExists: {
    pt: "Já existe um cadastro com este email. Use outro email ou acesse sua área.",
    en: "A signup with this email already exists. Use another email or access your area.",
    es: "Ya existe un registro con este email. Usa otro email o accede a tu área.",
  },
  influencerInvalidEmail: {
    pt: "Informe um email válido.",
    en: "Enter a valid email.",
    es: "Informa un email válido.",
  },
  influencerInvalidWhatsapp: {
    pt: "Informe um WhatsApp válido com código do país.",
    en: "Enter a valid WhatsApp number with country code.",
    es: "Informa un WhatsApp válido con código de país.",
  },
  influencerCategoryRequired: {
    pt: "Selecione pelo menos uma categoria.",
    en: "Select at least one category.",
    es: "Selecciona al menos una categoría.",
  },
  influencerOtherProfessionRequired: {
    pt: "Informe a profissão quando selecionar outras profissões.",
    en: "Enter the profession when selecting other professions.",
    es: "Informa la profesión al seleccionar otras profesiones.",
  },
  influencerLanguageRequired: {
    pt: "Selecione pelo menos um idioma.",
    en: "Select at least one language.",
    es: "Selecciona al menos un idioma.",
  },
  influencerSignupSuccess: {
    pt: "Cadastro recebido. A equipe vai avaliar sua aprovação e você poderá acessar o painel após ser aprovado.",
  ...
  meetingBooked: {
    pt: "Agendamento confirmado com sucesso.",
    en: "Meeting booked successfully.",
    es: "Reunión agendada correctamente.",
  },
  meetingInvalid: {
    pt: "Preencha horário, nome, email, WhatsApp e país.",
    en: "Fill in time, name, email, WhatsApp, and country.",
    es: "Completa horario, nombre, email, WhatsApp y país.",
  },
  meetingSlotUnavailable: {
    pt: "Esse horário não está mais disponível. Escolha outro horário liberado.",
    en: "This time is no longer available. Choose another released time.",
    es: "Ese horario ya no está disponible. Elige otro horario liberado.",
  },
  meetingSlotCreated: {
    pt: "Horário liberado com sucesso.",
    en: "Time slot released successfully.",
    es: "Horario liberado correctamente.",
  },
  meetingSlotDeleted: {
    pt: "Horário excluído com sucesso.",
    en: "Time slot deleted successfully.",
    es: "Horario eliminado correctamente.",
  },
  meetingSlotActivated: {
    pt: "Horário ativado com sucesso.",
    en: "Time slot activated successfully.",
    es: "Horario activado correctamente.",
  },
  meetingSlotDeactivated: {
    pt: "Horário desativado com sucesso.",
    en: "Time slot deactivated successfully.",
    es: "Horario desactivado correctamente.",
  },
  meetingCanceled: {
    pt: "Reunião marcada como cancelada.",
    en: "Meeting marked as canceled.",
    es: "Reunión marcada como cancelada.",
  },
  meetingSlotInvalid: {
    pt: "Informe data, hora e duração válidas.",
    en: "Enter a valid date, time, and duration.",
    es: "Informa fecha, hora y duración válidas.",
  },
  meetingSlotPast: {
    pt: "O horário precisa ser no futuro.",
    en: "The time slot must be in the future.",
    es: "El horario debe estar en el futuro.",
  },
  meetingSlotDuplicate: {
    pt: "Já existe um horário liberado com essa data e duração.",
    en: "A slot with this date and duration already exists.",
    es: "Ya existe un horario liberado con esa fecha y duración.",
  },
} as const
...
const ptPtMessages: Messages = {
  ...
  feedback: {
    ...
    influencerEmailExists: "Já existe um registo com este email. Use outro email ou aceda à sua área.",
    influencerInvalidEmail: "Informe um email válido.",
    influencerInvalidWhatsapp: "Informe um WhatsApp válido com indicativo do país.",
    influencerCategoryRequired: "Selecione pelo menos uma categoria.",
    ...
    meetingBooked: "Agendamento confirmado com sucesso.",
    meetingInvalid: "Preencha horário, nome, email, WhatsApp e país.",
    meetingSlotUnavailable: "Esse horário já não está disponível. Escolha outro horário liberado.",
    meetingSlotCreated: "Horário liberado com sucesso.",
    meetingSlotDeleted: "Horário eliminado com sucesso.",
    meetingSlotActivated: "Horário ativado com sucesso.",
    meetingSlotDeactivated: "Horário desativado com sucesso.",
    meetingCanceled: "Reunião marcada como cancelada.",
    meetingSlotInvalid: "Informe data, hora e duração válidas.",
    meetingSlotPast: "O horário precisa ser no futuro.",
    meetingSlotDuplicate: "Já existe um horário liberado com essa data e duração.",
  },
}
...
const frMessages: Messages = {
  ...
  feedback: {
    ...
    influencerEmailExists: "Une inscription avec cet email existe déjà. Utilisez un autre email ou accédez à votre espace.",
    influencerInvalidEmail: "Indiquez un email valide.",
    influencerInvalidWhatsapp: "Indiquez un WhatsApp valide avec l'indicatif du pays.",
    influencerCategoryRequired: "Sélectionnez au moins une catégorie.",
    ...
    meetingBooked: "Rendez-vous confirmé avec succès.",
    meetingInvalid: "Renseignez l'horaire, le nom, l'email, WhatsApp et le pays.",
    meetingSlotUnavailable: "Cet horaire n'est plus disponible. Choisissez un autre horaire publié.",
    meetingSlotCreated: "Horaire publié avec succès.",
    meetingSlotDeleted: "Horaire supprimé avec succès.",
    meetingSlotActivated: "Horaire activé avec succès.",
    meetingSlotDeactivated: "Horaire désactivé avec succès.",
    meetingCanceled: "Réunion marquée comme annulée.",
    meetingSlotInvalid: "Indiquez une date, une heure et une durée valides.",
    meetingSlotPast: "L'horaire doit être dans le futur.",
    meetingSlotDuplicate: "Un horaire existe déjà avec cette date et cette durée.",
  },
}
